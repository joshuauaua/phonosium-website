...
- **Ink Lead** (`#2a251f`): lead paragraph text where slightly softer than pure ink is needed (5.2:1 contrast on paper).
...
- **Stone** (`#8a847c`): muted text, placeholders.
- **Stone Dark** (`#5a544c`): labels and metadata needing stronger contrast than Stone (4.6:1).
