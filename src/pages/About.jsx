    ...
    <main className={styles.main}>
      <div className={styles.container}>
        ...
        <p className={styles.subtitle}>
          A living, breathing sound installation that bridges the physical and digital.
          Wrapped around a shipping container at Frihamnstorget, this network of PVC pipes
          serves as an interactive interface for sonic exploration.
        </p>
        ...
        <section className={styles.section}>
          ...
          <p>
            Phonosium is a collaborative sonic experiment powered by a Bela.io microcontroller.
            Four electret microphones embedded in the PVC structure capture local interactions,
            while four high-fidelity speakers broadcast generative soundscapes that react in real-time
            to the environment.
          </p>
          <p>
