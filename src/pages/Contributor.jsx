    ...
    <main className={styles.main}>
      ...
      <section className={styles.description}>
        ...
        <p className={styles.descriptionText}>
          ...
          visitors can experience a dynamic soundscape built from contributions
          around the world. Each contributor provides audio loops and samples
          that are played through our 6-speaker system, creating a unique sonic
          environment shaped by the community.
        </p>
        <p className={styles.descriptionText}>
          Your submission becomes part of the living installation, triggered and
          layered with other contributions to form an ever-evolving composition.
          This is an opportunity to share your sonic perspective and contribute
          to a collective auditory experience.
        </p>
      </section>
